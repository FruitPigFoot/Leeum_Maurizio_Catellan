  ...
  const sceneInfo = [
    ...
    },
    {
      ...
      values: {
        ...
        messageD_translateY_in: [30, 0, { start: 0.75, end: 0.8 }], //new
        ...
        messageD_opacity_in: [0, 1, { start: 0.75, end: 0.8 }], //new
        messageA_translateY_out: [0, -20, { start: 0.2, end: 0.25 }],
        messageB_translateY_out: [0, -20, { start: 0.45, end: 0.5 }],
        messageC_translateY_out: [0, -20, { start: 0.65, end: 0.7 }],
        messageD_translateY_out: [0, -20, { start: 0.85, end: 0.9 }], //new
        messageA_opacity_out: [1, 0, { start: 0.2, end: 0.25 }],
        messageB_opacity_out: [1, 0, { start: 0.45, end: 0.5 }],
        messageC_opacity_out: [1, 0, { start: 0.65, end: 0.7 }],
        messageD_opacity_out: [1, 0, { start: 0.85, end: 0.9 }], //new
        pinB_scaleY: [0.5, 1, { start: 0.35, end: 0.4 }],
        pinC_scaleY: [0.5, 1, { start: 0.55, end: 0.6 }],
        pinD_scaleY: [0.5, 1, { start: 0.75, end: 0.8 }], //new
        pinB_opacity_in: [0, 1, { start: 0.35, end: 0.4 }],
        pinC_opacity_in: [0, 1, { start: 0.55, end: 0.6 }],
        pinD_opacity_in: [0, 1, { start: 0.75, end: 0.8 }], //new
        pinB_opacity_out: [1, 0, { start: 0.45, end: 0.5 }],
        pinC_opacity_out: [1, 0, { start: 0.65, end: 0.7 }],
        pinD_opacity_out: [1, 0, { start: 0.85, end: 0.9 }], //new
      },
      finishedLoadingImages: false,
    },
    {
    ...
    switch (currentScene) {
      case 0:
        ...
        if (scrollRatio <= 0.42) {
          ...
          objs.messageB.style.transform = `translate3d(0px, ${calcValues(
      ...
      case 2:
        ...
        if (scrollRatio <= 0.83) {
          ...
          objs.pinD.style.transform = `scaleY(${calcValues(
            values.pinC_scaleY,
            currentYOffset
          )})`;
        } else {
